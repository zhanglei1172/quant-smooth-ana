...
class CustomDataLoader(BaseDataLoader):
    ...
    def __init__(self, file_path: str, tokenizer, num_samples: int = 64, 
                 seq_len: int = 1024, seed: int = 0, format: str = 'text',
...
class JSONDataLoader(CustomDataLoader):
    ...
    def __init__(self, file_path: str, tokenizer, num_samples: int = 64, 
                 seq_len: int = 1024, seed: int = 0, text_column: str = 'text'):
        super().__init__(file_path, tokenizer, num_samples, seq_len, seed, 'json', text_column)
...
class CSVDataLoader(CustomDataLoader):
    ...
    def __init__(self, file_path: str, tokenizer, num_samples: int = 64, 
                 seq_len: int = 1024, seed: int = 0, text_column: str = 'text'):
        super().__init__(file_path, tokenizer, num_samples, seq_len, seed, 'csv', text_column)
