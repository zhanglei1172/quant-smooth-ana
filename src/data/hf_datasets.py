...
class HFDatasetLoader(BaseDataLoader):
    ...
    def __init__(self, dataset_name: str, tokenizer, num_samples: int = 64, 
                 ...
                 text_column: str = 'text', subset: Optional[str] = None):
        """
...
def get_hf_dataloader(dataset_name: str, tokenizer, num_samples: int = 64,
                     seq_len: int = 1024, seed: int = 0, split: str = 'validation',
                     text_column: str = 'text', subset: Optional[str] = None) -> HFDatasetLoader:
    """
    获取HuggingFace数据集加载器
